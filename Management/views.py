...
# VIEWS para manejo de uso de base/base.html, (base_customer o base_recepcionist)
...
def template_base(user_type):
    if user_type == "Customer":
        base_template = 'base/base_customer.html'
    elif user_type == "Recepcionist":
        base_template = 'base/base_recepcionist.html'
    else:
